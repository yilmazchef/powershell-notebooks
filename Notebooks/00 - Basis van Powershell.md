...
1. [Short description](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#short-description)
2. [Long description](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#long-description)
3. [Common features](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#common-features)
4. [Equality operators](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#equality-operators)
5. [Matching operators](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#matching-operators)
6. [Replacement operator](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#replacement-operator)
7. [Containment operators](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#containment-operators)
8. [Type comparison](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#type-comparison)
9. [See also](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#see-also)

## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#short-description)Short description
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#long-description)Long description
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#common-features)Common features
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#equality-operators)Equality operators

### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-eq-and--ne)\-eq and -ne
...
In this example, we created two objects with identical properties. Yet, the equality test result is **False** because they are different objects. To create comparable classes, you need to implement [System.IEquatable<T>](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/en-us/dotnet/api/system.iequatable-1) in your class. The following example demonstrates the partial implementation of a **MyFileInfoSet** class that implements [System.IEquatable<T>](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/en-us/dotnet/api/system.iequatable-1) and has two properties, **File** and **Size**. The `Equals()` method returns **True** if the File and Size properties of two **MyFileInfoSet** objects are the same.
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-gt--ge--lt-and--le)\-gt, -ge, -lt, and -le
...
In most programming languages the greater-than operator is `>`. In PowerShell, this character is used for redirection. For details, see [about\_Redirection](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/en-us/dotnet/api/system.text.regularexpressions.match).
...
These operators work with any class that implements [System.IComparable](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/en-us/dotnet/api/system.icomparable).
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#matching-operators)Matching operators
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-like-and--notlike)\-like and -notlike
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-match-and--notmatch)\-match and -notmatch
...
For details, see [about\_Regular\_Expressions](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_regular_expressions?view=powershell-7.2) and [about\_Automatic\_Variables](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_automatic_variables?view=powershell-7.2).

## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#replacement-operator)Replacement operator

### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#replacement-with-regular-expressions)Replacement with regular expressions
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#regular-expressions-substitutions)Regular expressions substitutions
...
To learn more, see [about\_Regular\_Expressions](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_regular_expressions?view=powershell-7.2) and [Substitutions in Regular Expressions](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_redirection?view=powershell-7.2#potential-confusion-with-comparison-operators).

### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#substituting-in-a-collection)Substituting in a collection
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#replacement-with-a-script-block)Replacement with a script block
...
Within the script block, use the `$_` automatic variable to access the input text being replaced and other useful information. This variable's class type is [System.Text.RegularExpressions.Match](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/en-us/dotnet/api/system.text.regularexpressions.match).
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#containment-operators)Containment operators
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-contains-and--notcontains)\-contains and -notcontains
...
### [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#-in-and--notin)\-in and -notin
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#type-comparison)Type comparison
...
## [](chrome-extension://hajanaajapkhaabfcofdjgjnlgkdkknm/_generated_background_page.html#see-also)See also

- [about\_Booleans](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_booleans?view=powershell-7.2)
- [about\_Operators](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_operators?view=powershell-7.2)
- [about\_Regular\_Expressions](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_regular_expressions?view=powershell-7.2)
- [about\_Wildcards](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_wildcards?view=powershell-7.2)
...
### Add-Content (Microsoft.PowerShell.Management) - PowerShell
    ...
    The Add-Content cmdlet appends content to a specified item or file. You can specify the content by typing the content in the command or by specifying an object that contains the content. If you need to create files or directories for the following examples, see New-Item.
